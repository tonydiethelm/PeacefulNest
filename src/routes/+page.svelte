<main>
    ...
    <section>
        <div class="piccontainer">
            <img class="circle" src="TheaFoot.jpeg" alt="Picture of a baby's feet.">
            <p>Thea's toes by <a href="https://www.purplestarrphotos.com/">PurpleStarr Photos</a>.</p>
        </div>
        <div>
            <p>I believe every family deserves emotional and practical support during this 
                ...
                the wisdom and intuition that already exists in every parent. 
            </p>
        </div>
    </section>
